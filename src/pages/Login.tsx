      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-140px)] px-6">
        <div className="w-full max-w-4xl flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-24">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <div className="relative w-[240px] h-[500px] bg-gradient-to-b from-[hsl(270,40%,25%)] to-[hsl(260,35%,15%)] rounded-[32px] p-3 shadow-2xl">
              {/* Phone Header */}
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex-1 mx-2 h-8 bg-white/10 rounded-full flex items-center px-3">
              ...
              <div className="text-center mb-5">
                <p className="text-white/60 text-xs mb-1">Bills</p>
                <div className="flex items-baseline justify-center">
                  <span className="text-3xl font-bold text-white">£100</span>
                  <span className="text-sm text-white/60">.67</span>
                </div>
                <button className="mt-2 h-6 px-3 bg-white/20 text-white text-xs rounded-full">
                  Accounts
                </button>
              </div>
              ...
              <div className="bg-[hsl(260,30%,12%)] rounded-xl p-3 space-y-3">
                ...
                <button className="w-full text-center text-white/60 text-[10px] hover:text-white transition-colors pt-1">
                  See all
                </button>
              </div>
            </div>
            ...
            <div className="relative w-[180px] h-[380px] bg-[hsl(220,20%,10%)] rounded-[28px] p-3 shadow-xl -ml-6 mt-16">
              {/* Back Arrow */}
              <div className="mb-3">
              ...
              <div className="relative w-28 h-28 mx-auto mb-3">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span className="text-white/40 text-[10px]">25% · 6 days left</span>
                </div>
              </div>
